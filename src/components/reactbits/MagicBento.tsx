...
export const BentoCard: React.FC<BentoCardProps> = ({
  ...
  return (
    <div
      ref={cardRef}
      onClick={onClick}
      className={`bento-card relative overflow-hidden rounded-2xl transition-all duration-300 ease-in-out hover:-translate-y-1 cursor-pointer ${variantClasses[variant]} ${enableBorderGlow ? 'bento-card--border-glow' : ''} ${className}`}
      style={{
        '--glow-x': '50%',
        '--glow-y': '50%',
        '--glow-intensity': '0',
      ...
      <style>
        {`
          ...
          .bento-card--border-glow:hover {
            box-shadow: 0 8px 30px rgba(0, 0, 0, 0.2), 0 0 40px rgba(${glowColor}, 0.15);
          }
