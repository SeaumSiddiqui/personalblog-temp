...
export const ProjectBento: React.FC<ProjectBentoProps> = ({
  ...
  const glowColor = isDarkMode ? colors.primary[500] : colors.primary[400];
  ...
  return (
    <>
      ...
      <div className="project-bento-section" ref={gridRef}>
        <div className="grid gap-4 md:gap-6 auto-rows-fr grid-cols-1 md:grid-cols-2">
          {projects.map((project, index) => {
            const baseClassName = `project-card flex flex-col relative w-full p-6 md:p-8 rounded-2xl border-2 transition-all duration-300 ${
              enableBorderGlow ? 'project-card--border-glow' : ''
            } ${
              isDarkMode
                ? 'bg-dark-card border-dark-border hover:border-primary-700'
                : 'bg-light-card border-light-border hover:border-primary-300'
            }`;
            ...
            return (
              <ParticleCard
                key={index}
                className={`${baseClassName} ${project.link ? 'cursor-pointer' : ''}`}
                style={cardStyle}
                ...
                <div className="flex-1 flex flex-col gap-4 z-10">
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {project.link && (
                        <ExternalLink className={`w-5 h-5 flex-shrink-0 transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 ${
